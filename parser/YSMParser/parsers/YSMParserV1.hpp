...
class YSMParserV1 : public YSMParser {
public:
	YSMParserV1(std::unique_ptr<char[]> buffer, size_t size) : m_buffer(std::move(buffer)) , m_size(size) {}
	~YSMParserV1() = default;
	int getYSGPVersion() override { return 1; };
